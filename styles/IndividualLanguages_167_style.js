...
var style_IndividualLanguages_167 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("language_name") !== null && resolution > 489 && resolution < 1956) {
        labelText = String(feature.get("language_name"));
    }
